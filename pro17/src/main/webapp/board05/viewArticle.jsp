...
<body>
<form name="frmArticle" method="post" action="${contextPath}" enctype="mutipart/form-data">
...
<tr id="tr_btn">
	<td colspan=2 align="center">
		...
		<input type="button" value="삭제하기" onClick="fn_rempove_article('${contextPath}/board5/removeArticle.do', ${article.articleNO })">
